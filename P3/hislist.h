...
typedef struct tNodeHis *tPosHisL;
...
// Dado la dirección de memoria de una variable tHisList, inicializar una lista vacía
void HList_aux_createEmptyList(tHisList *lista);

// Comprueba si una lista (tHisList) está vacía
